...
//     Entity* entity = new Entity(shader, Texture("tex2.jpg", TextureFormats::JPG), glm::vec3(100.0, 100.0, 0.0));
...
//     m_eventSubscriber.SetOnNotifyCallback([&applicationInterface, &window, &renderer, &entity](Event* event) {
//         applicationInterface.Execute<void>("OnEvent", event, window, renderer, entity);
//        // applicationInterface.Execute<void>("click", event, window, renderer);
//     });
